...
ACADOS_PATH= $(LIBRARYPATH)/acados
BLASFEO_PATH= $(LIBRARYPATH)/blasfeo
HPIPM_PATH= $(LIBRARYPATH)/hpipm

L_INC += -I$(LIBRARYPATH) -I$(ACADOS_PATH)/interfaces -I$(ACADOS_PATH)/include -I$(BLASFEO_PATH)/include -I$(HPIPM_PATH)/include
LDFLAGS += -L$(ACADOS_PATH)/lib
